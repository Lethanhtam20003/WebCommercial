...
(
    product_image_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    name             VARCHAR(255),
    image            VARCHAR(255),
    product_id       BIGINT                                  NOT NULL,
...
(
    purchase_order_item_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
(
    ...
    user_id   BIGINT NOT NULL,
    CONSTRAINT pk_user_coupon PRIMARY KEY (coupon_id, user_id)
);
...
ALTER TABLE user_coupon
    ADD CONSTRAINT fk_usecou_on_coupon FOREIGN KEY (coupon_id) REFERENCES coupons (coupon_id);

ALTER TABLE user_coupon
    ADD CONSTRAINT fk_usecou_on_user FOREIGN KEY (user_id) REFERENCES users (user_id);